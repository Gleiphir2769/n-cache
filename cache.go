...
func (b *mBucket) get(r *Cache, h *mNode, hash uint32, key string, noset bool) (done, added bool, n *Node) {
	b.mu.Lock()
...
func (b *mBucket) delete(r *Cache, h *mNode, hash uint32, key string) (done, deleted bool) {
	b.mu.Lock()
